...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static List<string> oldnames = new List<string>();
        ...
        static void DisplayMenu()
        {
            ...
            Console.WriteLine("7. Display history");
        ...
        static void DisplayOldNames()
        {
            if (oldnames.Count == 0)
            {
                Console.WriteLine("No updations yet");
            }
            foreach(var patient in oldnames)
                {
