...
internal class Program
{
    static void Main()
    {
        ...
        foreach (var patient in patients.Take(20))
        {
            Console.WriteLine("This is the change for second commit in git");
            string json = JsonConvert.SerializeObject(patient, Formatting.Indented);
            Console.WriteLine(json);
        }

        Console.WriteLine();
        Console.WriteLine("Remaining 980 records were generated but not displayed.");
